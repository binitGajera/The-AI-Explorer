...
def main(args):
    ...
    agent = QuadAgent(args.height, args.width, args.initial_strength)

    agents = [agent]
    another_agent = RandomAgent(args.height, args.width, args.initial_strength)
    agents.append(another_agent)
